...
export default function HomePage() {
  return (
    <div className="home-container">
      <svg className="site-logo" width="48" height="48" viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="site-tagline">Search Chinese, Pinyin, or English — 120,000+ entries</p>
